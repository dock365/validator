...
describe('String Validator', () => {
  ...
  describe('Type', () => {
    ...
    it('should return success: false with custom message when the value is not string', () => {
      const result = validator.string(
        ...
        65,
        {},
        { type: '$title Custom type message' }
      );
      ...
      expect(result.messages)
        .to.be.an('array')
        .that.include(
          validationMessage('$title Custom type message', {
            field: 'Title',
            type: validationTypes.String,
          })
        );
  ...
  describe('RegX', () => {
    it('should return success: false with message when the value does not match regx', () => {
      const result = validator.string('Title', 'Good Morning', {
        regx: /Hello/g,
      });
      expect(result.success).to.equal(false);
      expect(result.messages)
    ...
    it('should return success: true without message when the value match regx', () => {
      const result = validator.string('Title', 'Hello World', {
        regx: /Hello/g,
      });
      expect(result.success).to.equal(true);
      // tslint:disable-next-line:no-unused-expression
  ...
  describe('Min Length', () => {
    ...
    it('should return success: false with custom message when the value is less than min length', () => {
      ...
      expect(result.messages)
        .to.be.an('array')
        .that.include(
          validationMessage('$title Custom minLength message', {
            field: 'Title',
            type: validationTypes.String,
            minLength: '3',
          })
  ...
  describe('Max Length', () => {
    ...
    it('should return success: false with custom message when the value is greater than max length', () => {
      ...
      expect(result.messages)
        .to.be.an('array')
        .that.include(
          validationMessage('$title Custom maxLength message', {
            field: 'Title',
            type: validationTypes.String,
            maxLength: '3',
          })
  ...
  describe('Include', () => {
    it('should return success: true without message when the value contain a perticular string', () => {
      const result = validator.string('Title', 'Neque porro quisquam est qui', {
        include: 'porro',
      });
...
describe('String Validator With Initialized Custome Message', () => {
  const failMessages = {
    ...
    maxLength:
      "Updated start $field can't be greater than $maxLength ! Updated end",
    maxValue:
      "Updated start $field can't be greater than $maxValue! Updated end",
    minLength:
      "Updated start $field can't be less than $minLength charectors! Updated end",
    minValue: "Updated start $field can't be less than $minValue! Updated end",
    noTrailingSpace:
      'Updated start $field must not contain any trailing spaces! Updated end',
  ...
  describe('RegX', () => {
    it('should return success: false with message when the value does not match regx', () => {
      ...
      expect(result.messages)
        .to.be.an('array')
        .that.include(
          validationMessage(failMessages.regx, {
            field: 'Title',
            type: validationTypes.String,
            regx: '/Hello/g',
          })
  ...
  describe('Min Length', () => {
    it('should return success: false with message when the value is less than min length', () => {
      ...
      expect(result.messages)
        .to.be.an('array')
        .that.include(
          validationMessage(failMessages.minLength, {
            field: 'Title',
            type: validationTypes.String,
            minLength: '3',
          })
  ...
  describe('Max Length', () => {
    it('should return success: false with message when the value is greater than max length', () => {
      ...
      expect(result.messages)
        .to.be.an('array')
        .that.include(
          validationMessage(failMessages.maxLength, {
            field: 'Title',
            type: validationTypes.String,
            maxLength: '3',
          })
